...
import 'package:pavanportfolio/view%20model/getx_controllers/projects_controller.dart';
import 'package:pavanportfolio/view%20model/responsive.dart';
import 'package:pavanportfolio/view/projects/components/title_text.dart';
        ...
        children: [
          ...
          Expanded(
              child: Responsive(
                  ...
                  tablet: ProjectGrid(ratio: 1.7,crossAxisCount: 2,)))
        ],
      ),
    );
  }
